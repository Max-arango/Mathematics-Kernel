...
export function ProbabilityBars() {
  ...
  return (
    <div className="w-64 rounded-lg bg-black/70 p-3 backdrop-blur-sm ring-1 ring-white/10">
      <h3 className="mb-2 text-[11px] font-semibold uppercase tracking-widest text-vermilion-300/70">Measurement P</h3>

      <div className="mb-2">
        <div className="mb-1 text-[10px] uppercase tracking-wide text-stone-500">Z basis (computational)</div>
      ...
      <div className="mb-2">
        <div className="mb-1 text-[10px] uppercase tracking-wide text-stone-500">X basis</div>
        <div className="space-y-1">
      ...
      <div>
        <div className="mb-1 text-[10px] uppercase tracking-wide text-stone-500">Y basis</div>
        <div className="space-y-1">
